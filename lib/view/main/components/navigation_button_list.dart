      ...
      return Transform.scale(
        ...
        child: Row(
          children: [
            ...
            NavigationTextButton(onTap: () {controller.animateToPage(3, duration: const Duration(milliseconds: 500), curve: Curves.easeIn);}, text: 'Education'),
            // NavigationTextButton(onTap: () {controller.animateToPage(5, duration: const Duration(milliseconds: 500), curve: Curves.easeIn);}, text: 'Certifications'),
          ],
        ),
      );
    },);
